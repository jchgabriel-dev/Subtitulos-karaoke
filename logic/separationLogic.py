...
class SeparationLogic(QMainWindow, StyleLoad):

    def __init__(self, separation_thread):
        super().__init__()
        self.progress = 0
        self.separation_thread = separation_thread
        self.progressInterface = Separation(self)
