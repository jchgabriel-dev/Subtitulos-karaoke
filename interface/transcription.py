...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QProgressBar, QLabel

from general.styleLoad import StyleLoad


class Transcription(StyleLoad):
    def __init__(self, progress):
        super().__init__()
        progress.cargar_css("style/transcriptionStyle.css")
        progress.setWindowTitle("Transcripcion de audio")
